...
firmware = '_build/dfu_app_hrs_s130_nrf51_sdk12.3.0/app_s130_nrf51422_sdk12.3.0'
...
create = b"\x01"
command_object = b"\x01"
# calculate app.dat size: 141 bytes
size = os.path.getsize(firmware_dat)  # Size of app.dat
size_object = struct.pack("<I", size)  # Convert to 4 bytes little endian
...
# Sending the dat file
print("Sending the dat file\n")
...
DFU_control_point.value = calculate_crc_code
sleep(3)
print("---------")

# Execute the sent file (the dat file)
print("Execute the sent file (the dat file)\n")
excetute_code = b"\x04"
...
create = b"\x01"
data_object = b"\x02"
size = os.path.getsize(firmware_bin)  # Size of app.bin
size_object = struct.pack("<I", size)  # Convert to 4 bytes little endian
...
# Send firmware app.bin
print("Sending firmware app.bin image\n")
